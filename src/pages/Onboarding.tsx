...
const FEATURES = [
  {
    ...
    description: "Test your trading ideas on historical market data with realistic execution including slippage and brokerage costs.",
    color: "text-primary",
    bg: "bg-primary/10",
  },
  {
    ...
    description: "Track every trade and evaluate profit, drawdown, win rate, and risk metrics for each strategy.",
    color: "text-accent",
    bg: "bg-accent/10",
  },
  {
    ...
    description: "Get insights into how each strategy performs over time and surface ones that need re-validation.",
    color: "text-success",
    bg: "bg-success/10",
  },
];
